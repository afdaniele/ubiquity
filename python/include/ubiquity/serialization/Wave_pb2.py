...
_WAVEHEADERPB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shoebox_name', full_name='WaveHeaderPB.shoebox_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='request_wave', full_name='WaveHeaderPB.request_wave', index=2,
...
_FIELDSETREQUESTPB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='field_value', full_name='FieldSetRequestPB.field_value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FIELDSETREQUESTPB.fields_by_name['field_value'].message_type = google_dot_protobuf_dot_any__pb2._ANY
